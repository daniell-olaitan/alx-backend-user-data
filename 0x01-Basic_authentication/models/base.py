...
class Base():
    ...
    def __eq__(self, other: Base_Type) -> bool:
        """ Equality
        """
    ...
    @classmethod
    def all(cls) -> Iterable[Base_Type]:
        """ Return all objects
        """
        return cls.search()

    @classmethod
    def get(cls, id: str) -> Base_Type:
    ...
    @classmethod
    def search(cls, attributes: dict = {}) -> List[Base_Type]:
